...
class course_filter_form extends \moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('text', 'courseid', get_string('courseid'));
        $mform->setType('courseid', PARAM_ALPHANUM);
        $mform->addRule('courseid', get_string('only_number', 'lifecyclestep_adminapprove'), 'numeric');

        $mform->addElement('text', 'coursename', get_string('coursename'));
